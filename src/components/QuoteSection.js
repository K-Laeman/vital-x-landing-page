            ...
            <div className="relative w-full flex flex-col px-6 pt-12 gap-12 overflow-hidden md:hidden">
                <div className="flex justify-center items-center">
                    <div className="flex flex-col justify-center text-center gap-4 md:mt-12">
                        <h1 className="text-3xl md:text-5xl font-medium text-sky-700">
                            {`มื้อนี้.....ให้เราดูแล`}
                        </h1>
                        <p className="text-lg md:text-5xl font-light text-sky-700">
                        ...
                        {/* <h1 className="text-3xl md:text-5xl text-sky-700">
                            {`ปัจจัยที่เร่งให้เซลล์แก่`}
                        </h1>
                        <h1 className=" font-semibold text-4xl text-sky-700">
                            {`ไม่ใช่ “อายุ”`}
                        </h1>
                        <h1 className="font-semibold text-4xl text-sky-700">
                            {`แต่เป็น “อาหาร"`}
                ...
                <div className="absolute bottom-0 flex flex-col w-full items-start pt-24 pb-8 px-6 bg-gradient-to-t from-white via-white ">
                    ...
                    <span className="text-base mt-1 font-light text-sky-700">
                        {`แพทย์เวชศาสตร์ชะลอวัยและผิวหนัง`}
                    </span>
                    <span className=" text-base font-light text-sky-700">
            ...
            <div className="hidden md:flex mx-7-xl mx-auto w-full">
                <div className="flex w-full px-6 bg-sky-50 rounded-xl pt-12">
                    <div className="flex flex-col px-6 justify-center w-1/2 gap-4">
                        ...
                        <span className="text-2xl font-light text-sky-700 leading-8">
                    ...
                    <div className="relative flex flex-col w-1/2">
                        ...
                        <div className="absolute bottom-0 flex flex-col w-full items-start pt-24 pb-8 px-6 bg-gradient-to-t from-sky-50 via-sky-50 ">
